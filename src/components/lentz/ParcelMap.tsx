...
const CAT_COLOR: Record<string, string> = {
  ...
  maavara: "#a16207", parand: "#9d174d", uleujutus: "#0284c7", rohev: "#65a30d",
  planeering: "#64748b", muu: "#5b6b61",
};
const CAT_ET: Record<string, string> = {
  ...
  uleujutus: "Üleujutusala", rohev: "Rohevõrgustik", planeering: "Planeering / asustus",
  muu: "Muu",
};
